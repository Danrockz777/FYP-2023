...
function showData(){
    ...
    html+=
        ...
        index +
        ')" class="btn btn-warning m-2">Edit</button><button onclick="Approve (' +
        index +
        ')" class="btn btn-info m-2">Approve</button><button onclick="Reject (' +
        index +
        ')" class="btn btn-dark m-2">Reject</button></td>';
    html+="</tr>";    
});
...
function Reject() {
    ...
    showData();
      ...
      //
       ...
       setTimeout(()=>{
        window.location.href = "mailto:@gmail.com?subject=Sports Facility Booking Rejected&body=Sorry for the inconvenience. Please choose another date and time. Thank you.";
        },3000)
